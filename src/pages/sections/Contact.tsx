        ...
        <div className="content-1300">
          <div className="row">
            ...
            <div className="one-half width-40">
              <p className="section-info">{data.user?.about.subTitle}</p>
              <p className="section-info">{data.user?.about.description}</p>
              <p className="section-info">
                {data.user?.about.quote}
                </p>
              <p>
                <Fragment>
                  <b>ADDRESS :</b> {data.user?.about.address} <br />
                </Fragment>
                <Fragment>
                  <b>EMAIL :</b> {data.user?.email} <br />
                </Fragment>
                <Fragment>
                  <b>PHONE :</b> {data.user?.about.phoneNumber} <br />
                </Fragment>
              </p>
